...
{
    [Header(" Managers ")]
    [SerializeField] private PlayersFormation squadFormation;
    ...
    private void Awake()
    {
        PlayersDetection.OnEnemiesDetected += SlowDown;
        PlayersDetection.OnNoEnemiesDetected += SpeedUp;

        PlayersDetection.OnFinishLineCrossed += FinishLineCrossedCallback;
    }
